...
| `openstack.network.v2.dynamic_routing` | 18/18 | 18/18 — BGP speakers, peers, dragent scheduling |
| `openstack.network.v2.taas` | 5/15 | 5/5 — tap mirrors; tap services and flows (10) have no gophercloud package and are outside the core denominator |
