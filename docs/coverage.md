...
**Snapshot:** 2026-09-25 · `koc` @ this commit (base `5cc80b1`) · 602 leaf
...
**552 of 947 in-scope upstream commands (58%).** Of `koc`'s 602 leaf commands,
552 are upstream-equivalent and 50 are koc-native.
...
reconciles with the headline (602 = 552 + 50):
...
```sh
# 1. koc's own command tree (602 leaf commands at the snapshot above)
make build
...
1. every raw row numerator summed = the headline numerator (552);
2. leaf commands = headline numerator + koc-native (602 = 552 + 50);
