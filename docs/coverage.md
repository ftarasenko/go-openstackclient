...
**Snapshot:** 2026-08-08 · `koc` @ this commit (base `d38f1a8`) · 417 leaf
...
**388 of 844 in-scope upstream commands (46%).** Of `koc`'s 417 leaf commands,
388 are upstream-equivalent and 29 are koc-native.
...
| --- | --- | --- |
| ironic (`baremetal`) | 43/118 (36%) | the full provision-state verb set, node lifecycle, power, ports, VIFs, BIOS settings, firmware, driver details and stored inventory are solid; missing allocations, chassis, port groups, traits, history, deploy templates, runbooks, inspection rules, volume connectors/targets. Sequenced in `docs/proposals/coverage-tiers.md` |
