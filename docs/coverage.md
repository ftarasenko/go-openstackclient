...
**Snapshot:** 2026-09-25 · `koc` @ this commit (base `5cc80b1`) · 580 leaf
...
reconciles with the headline (580 = 530 + 50):
...
```sh
# 1. koc's own command tree (580 leaf commands at the snapshot above)
make build
