...
func newProviderCreateCommand(a *auth.Options, o *output.Options) *cobra.Command {
	...
	fl.StringVar(&parent, "parent-provider", "", "UUID of the parent provider (placement 1.14 or later)")
	return cmd
}
...
func newProviderSetCommand(a *auth.Options, o *output.Options) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fl := cmd.Flags()
			if !fl.Changed("name") && !fl.Changed("parent-provider") {
			...
			return runProviderSet(ctx, client, o, args[0], name, parent,
				fl.Changed("name"), fl.Changed("parent-provider"), cmd.OutOrStdout())
		},
	}
	fl := cmd.Flags()
	fl.StringVar(&name, "name", "", "new provider name")
	fl.StringVar(&parent, "parent-provider", "",
...
func writeInventories(o *output.Options, w io.Writer, inventories map[string]resourceproviders.Inventory) error {
	t := output.Table{
		Columns: []string{"Resource Class", "Total", "Reserved", "Min Unit", "Max Unit", "Step Size", "Allocation Ratio"},
	}
...
func runProviderAllocationShow(ctx context.Context, client *gophercloud.ServiceClient, o *output.Options,
	...
	t := output.Table{Columns: []string{"Resource Provider", "Resource Class", "Used"}}
...
func runAllocationCandidateList(ctx context.Context, client *gophercloud.ServiceClient, o *output.Options,
	...
	t := output.Table{Columns: []string{"Resource Provider", "Resource Class", "Capacity", "Used"}}
...
func runResourceUsageShow(ctx context.Context, client *gophercloud.ServiceClient, o *output.Options,
	...
	t := output.Table{Columns: []string{"Resource Class", "Usage"}}
